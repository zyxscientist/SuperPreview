...
private enum DemoCopy {
    ...
    static let values: [DemoCopyKey: Values] = [
        ...
        .enterQuantity: ("输入数量", "輸入數量", "Enter QTY"),
        ...
        .effectPeriod: ("有效期", "有效期", "Time In Force"),
        .dayValid: ("当日有效", "當日有效", "Day"),
        .goodTillCancelled: ("撤单前有效", "撤單前有效", "GTC"),
        .selectEffectPeriod: ("选择有效期", "選擇有效期", "Select Time In Force"),
        ...
        .cashPurchasable: ("现金可买", "現金可買", "Cash Buy Qty"),
        .maximumPurchasable: ("最大可买", "最大可買", "Max Buy Qty"),
        .positionSellable: ("持仓可卖", "持倉可賣", "Mas Sell Qty"),
        ...
        .specifiedPrice: ("指定价", "指定價", "Lmt Price"),
        .followMarketPrice: ("跟市价", "跟市價", "Market Price"),
        .followBidOne: ("跟买一", "跟買一", "Bid 1"),
        .followAskOne: ("跟卖一", "跟賣一", "Ask 1"),
        .changePercent: ("涨跌幅", "漲跌幅", "Chg%"),
        .preMarket: ("盘前", "盤前", "Pre"),
        .afterHours: ("盘后", "盤後", "Post"),
        .stockInputPlaceholder: ("请输入股票", "請輸入股票", "Symbol/Name"),
        .searchPlaceholder: ("代码/名称/全拼/首字母", "代碼/名稱/全拼/首字母", "Symbol/Name"),
        .search: ("搜索", "搜尋", "Search"),
        .cancel: ("取消", "取消", "Cancel"),
        .clear: ("清除", "清除", "Clear"),
        .delete: ("删除", "刪除", "Delete"),
        ...
        .orderStatusHeader: ("订单状态", "訂單狀態", "Status"),
        .symbolHeader: ("名称代码", "名稱代碼", "Name"),
        .orderPriceHeader: ("委托价", "委託價", "Price"),
        ...
        .orderPendingSubmission: ("待提交", "待提交", "Pending"),
        .orderPendingFill: ("待成交", "待成交", "Submmited"),
        .orderPartiallyFilled: ("部分成交", "部分成交", "Partially Filled"),
        .orderFilled: ("全部成交", "全部成交", "Filled"),
        .orderFailed: ("下单失败", "下單失敗", "Failed"),
        ...
        .historyOrders: ("历史订单", "歷史訂單", "History"),
    ...
    static let securityNames: [String: Values] = [
        ...
        "wl-us-amazon": ("亚马逊", "亞馬遜", "Amazon"),
        "wl-us-alphabet-a": ("谷歌-A", "Google-A", "Alphabet A"),
        "wl-us-meta": ("Meta", "Meta", "Meta"),
        "wl-us-broadcom": ("博通", "博通", "Broadcom"),
        "wl-us-amd": ("AMD", "AMD", "AMD"),
        "wl-us-netflix": ("奈飞", "奈飛", "Netflix"),
        "wl-us-jpmorgan": ("摩根大通", "摩根大通", "JPMorgan Chase"),
        "wl-us-walmart": ("沃尔玛", "沃爾瑪", "Walmart"),
        "wl-us-coca-cola": ("可口可乐", "可口可樂", "Coca-Cola"),
        "wl-us-disney": ("迪士尼", "迪士尼", "Disney"),
