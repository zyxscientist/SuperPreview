...
struct EveningSummaryClipView: View {
    var body: some View {
        HStack(spacing: 0) {
...
struct EveningSummaryClipViewPreviews: PreviewProvider {
    static var previews: some View {
        EveningSummaryClipView().previewLayout(.sizeThatFits)
    }
}
