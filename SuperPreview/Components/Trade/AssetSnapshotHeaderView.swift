...
struct AssetSnapshotHeaderView: View {
...
struct AssetSnapshotHeaderViewPreviews: PreviewProvider {
    static var previews: some View {
        AssetSnapshotHeaderView(market:"香港")
