...
struct SymbolQuoteViewPreviews: PreviewProvider {
    static var previews: some View {
        SymbolQuoteView(openGraphView: .constant(false)) // constant 来维持正常预览
    }
}
