...
struct StockTradeTapeView: View {
...
struct StockTradeTapeViewPreviews: PreviewProvider {
    static var previews: some View {
        StockTradeTapeView(openTapeView: .constant(false))
    }
}

struct OtherTapeView: View {
    var body: some View {
        ZStack {
