//
//  SnapshotShortcutGridView.swift
//  SuperPreview
//
...
struct SnapshotShortcutGridView: View {
    var body: some View {
        VStack(spacing: 0.0) {
            
            AssetSnapshotHeaderView(market: "股票")
...
struct SnapshotShortcutGridViewPreviews: PreviewProvider {
