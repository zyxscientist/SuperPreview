//
//  SnapshotHoldingGainRowView.swift
//  SuperPreview
//
...
struct SnapshotHoldingGainRowView: View {
...
struct SnapshotHoldingGainRowViewPreviews: PreviewProvider {
    static var previews: some View {
        Group {
            SnapshotHoldingGainRowView(name: "苹果", symbol: "AAPL.US").previewLayout(.sizeThatFits)
            
            SnapshotHoldingGainRowView(name: "苹果", symbol: "AAPL.US")
