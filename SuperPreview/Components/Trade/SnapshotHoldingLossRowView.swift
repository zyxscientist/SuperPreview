//
//  SnapshotHoldingLossRowView.swift
//  SuperPreview
//
...
struct SnapshotHoldingLossRowView: View {
...
struct SnapshotHoldingLossRowViewPreviews: PreviewProvider {
    static var previews: some View {
        SnapshotHoldingLossRowView(name: "苹果", symbol: "AAPL.US")
    }
}
