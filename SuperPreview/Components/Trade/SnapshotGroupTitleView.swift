...
struct SnapshotGroupTitleView: View {
...
struct SnapshotGroupTitleViewPreviews: PreviewProvider {
    static var previews: some View {
        SnapshotGroupTitleView(flag_icon: "flag_US", title: "美股市场(USD)")
    }
}
